...
func buildToolCatalog() []models.ToolDefinition {
	...
	return []models.ToolDefinition{
		...
		{
			Name:        "holding_note_get",
			Description: "Get holding notes for a portfolio.",
			Method:      "GET",
			Path:        "/api/portfolios/{portfolio_name}/notes",
			Params: []models.ParamDefinition{
				portfolioParam,
			},
		},
		{
			Name:        "holding_note_set",
			Description: "Replace all holding notes for a portfolio.",
			Method:      "PUT",
			Path:        "/api/portfolios/{portfolio_name}/notes",
			Params: []models.ParamDefinition{
				portfolioParam,
				{
					Name:        "items",
					Type:        "array",
					Description: "Array of holding notes (same fields as add).",
					Required:    true,
					In:          "body",
				},
				{
					Name:        "notes",
					Type:        "string",
					Description: "Portfolio-level notes.",
					In:          "body",
				},
			},
		},
		{
			Name:        "holding_note_add",
			Description: "Add or update a holding note. Upserts by ticker.",
			Method:      "POST",
			Path:        "/api/portfolios/{portfolio_name}/notes/items",
			Params: []models.ParamDefinition{
				portfolioParam,
				{
					Name:        "ticker",
					Type:        "string",
					Description: "Ticker symbol (e.g. 'BHP.AU').",
					Required:    true,
					In:          "body",
				},
				{
					Name:        "asset_type",
					Type:        "string",
					Description: "ETF, ASX_stock, US_equity.",
					In:          "body",
				},
				{
				...
				{
					Name:        "known_behaviours",
					Type:        "string",
					Description: "Known patterns/behaviours.",
					In:          "body",
				},
				{
					Name:        "signal_overrides",
					Type:        "string",
					Description: "Context for interpreting signals.",
					In:          "body",
				},
				{
					Name:        "notes",
				...
				},
				{
					Name:        "stale_days",
					Type:        "number",
					Description: "Days until stale (default 90).",
					In:          "body",
				},
			},
		},
		{
			Name:        "holding_note_update",
			Description: "Update a holding note by ticker. Uses merge semantics — only provided fields are changed.",
			Method:      "PATCH",
			Path:        "/api/portfolios/{portfolio_name}/notes/items/{ticker}",
			Params: []models.ParamDefinition{
				portfolioParam,
				{
					Name:        "ticker",
				...
				},
				{
					Name:        "stale_days",
					Type:        "number",
					Description: "Days until stale.",
					In:          "body",
				},
			},
		},
		{
			Name:        "holding_note_remove",
			Description: "Remove a holding note by ticker.",
			Method:      "DELETE",
			Path:        "/api/portfolios/{portfolio_name}/notes/items/{ticker}",
			Params: []models.ParamDefinition{
				portfolioParam,
