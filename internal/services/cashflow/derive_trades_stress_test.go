...
func TestComputeXIRR_AllBuysNoSells_PositiveReturn(t *testing.T) {
	...
	transactions := []models.CashTransaction{
		{Type: models.CashTxDeposit, Date: time.Date(2023, 1, 1, 0, 0, 0, 0, time.UTC), Amount: 50000},
		{Type: models.CashTxDeposit, Date: time.Date(2023, 6, 1, 0, 0, 0, 0, time.UTC), Amount: 30000},
		{Type: models.CashTxDeposit, Date: time.Date(2024, 1, 1, 0, 0, 0, 0, time.UTC), Amount: 20000},
	}
...
func TestComputeXIRR_AllBuysNoSells_NegativeReturn(t *testing.T) {
	...
	transactions := []models.CashTransaction{
		{Type: models.CashTxDeposit, Date: time.Date(2023, 1, 1, 0, 0, 0, 0, time.UTC), Amount: 100000},
	}
...
func TestComputeXIRR_MixedBuysAndSells(t *testing.T) {
	...
	transactions := []models.CashTransaction{
		{Type: models.CashTxDeposit, Date: time.Date(2023, 1, 1, 0, 0, 0, 0, time.UTC), Amount: 50000},
		{Type: models.CashTxWithdrawal, Date: time.Date(2023, 6, 1, 0, 0, 0, 0, time.UTC), Amount: 20000},
		{Type: models.CashTxDeposit, Date: time.Date(2024, 1, 1, 0, 0, 0, 0, time.UTC), Amount: 30000},
	}
...
func TestXIRR_RapidTrading_ManyTransactions(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		txType := models.CashTxDeposit
		if i%2 == 1 {
			txType = models.CashTxWithdrawal
		}
...
func TestXIRR_NearZeroTimeSpan(t *testing.T) {
	// Deposit 1 second ago
	transactions := []models.CashTransaction{
		{Type: models.CashTxDeposit, Date: time.Now().Add(-time.Second), Amount: 100000},
	}
...
func TestXIRR_FutureDateTransaction(t *testing.T) {
	...
	transactions := []models.CashTransaction{
		{Type: models.CashTxDeposit, Date: time.Now().Add(365 * 24 * time.Hour), Amount: 100000},
	}
...
func TestXIRR_10000xReturn(t *testing.T) {
	...
	transactions := []models.CashTransaction{
		{Type: models.CashTxDeposit, Date: time.Now().AddDate(-1, 0, 0), Amount: 100},
	}
