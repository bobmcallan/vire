...
func TestSetTransactions_MixedSignBalance(t *testing.T) {
	...
	// ContributionsGross: only contributions = 100000 + 50000 = 150000 (dividends/other don't count)
	...
	// WithdrawalsGross: only contribution debits = 0 (fees, other withdrawals don't count)
