...
func testDB(t *testing.T) *surreal.DB {
	...
	tables := []string{"user", "user_kv", "system_kv", "user_data", "market_data", "signals", "stock_index", "job_queue", "files", "mcp_feedback", "oauth_client", "oauth_code", "oauth_refresh_token", "mcp_auth_session", "portfolio_timeline"}
