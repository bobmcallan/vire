...
3. **Bump version** — if `.version` exists, bump the patch number only:
   - Read current version (e.g. `version: 0.0.5`)
   - Increment patch: `0.0.5` → `0.0.6`
   - Update build timestamp: `build: YYYY-MM-DD-HH-MM-SS`
