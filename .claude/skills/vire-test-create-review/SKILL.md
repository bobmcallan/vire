# /vire-test-create-review - Create or Review Tests
...
## Usage
```
/vire-test-create-review <action> <layer> <target>
```
...
**Examples:**
- `/vire-test-create-review create unit internalstore` — Create storage unit tests
- `/vire-test-create-review create data marketstore` — Create data layer tests
- `/vire-test-create-review create api user` — Create API integration tests
- `/vire-test-create-review review unit internalstore` — Review and fix storage unit tests
- `/vire-test-create-review review api` — Review and fix all API tests
- `/vire-test-create-review audit` — Audit all tests for compliance (no changes)

## Prerequisites

Read `/vire-test-common` for:
...
Create the test file using the appropriate template below. Ensure compliance with all mandatory rules from `/vire-test-common`.
...
## Recommendation
Run `/vire-test-create-review review <layer> <target>` to fix.
```
