...
func TestFeedbackLifecycle(t *testing.T) {
	...
	// Update
	require.NoError(t, store.Update(ctx, fb.ID, models.FeedbackStatusAcknowledged, "Looking into it", "", "", "", nil))
...
func TestFeedbackSummary(t *testing.T) {
	...
	// Resolve one
	require.NoError(t, store.Update(ctx, fb2.ID, models.FeedbackStatusResolved, "fixed", "", "", "", nil))
